...
class GameState2048 {
 ...
 protected:
  ...
  /**
   * Pushes all the tiles in one direction, merges pairs with the same value to
   * make higher tiles
 ...
 public:
   ...
   * @param board: matrix of numbers 0 (empty), 2, 4, 8, ..., which represents
   * the game state
  ...
  /**
   * Gets the score of the current game state. The score is defined as the sum
   * of all the tiles that are present on the game board.
